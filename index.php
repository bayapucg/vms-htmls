  ...
  transform: translate(12%, -50%);">
	...
	<div class="px-5 search-main-label">
				  ...
				  <!-- Default inline 1-->
					...
					<div class="custom-control custom-checkbox custom-control-inline">
					  ...
					  <label class="custom-control-label" for="defaultInline3">Box</label>
					</div>
				  </div>
				  </div>
	</div>
              ...
              <div class="card-body" style="padding:0;">
                ...
                <form name="">
				  ...
				  <div class="md-form col-md-2">
                      <button class="btn btn-indigo btn-sm">Find Price</button>
                  </div>
                  </div>
    ...
    <main class="mt-5 pt-2">
        <div class="container">
			...
			<section class="text-center"><!--Grid row-->
	...
	<div class="container py-4">
			...
			<section  style="background-image: url('img/app-banner.png');background-repeat: no-repeat; background-size: cover; "><!--Grid row-->
                <div class=" container">
					<div class="row blog">
