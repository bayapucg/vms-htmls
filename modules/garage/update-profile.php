                        ...
                        <form id="defaultForm" method="post" class="" action="update-profile.php">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" name="username" value="Garage Owner1" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" name="username" value="9-25, station road, near amberpet loal shop" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" name="username" value="Hyderabad" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" name="username" value="Telangana" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" name="username" value="50016" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
