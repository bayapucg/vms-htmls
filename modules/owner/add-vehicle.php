                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type=" text" class="form-control " name="username" placeholder="Enter Rc No">
                                    </div>
                                    <!-- /.input group -->
                                </div> 
								<div class="col-md-3">
					...
					<div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type=" text" class="form-control " name="username" placeholder="Enter Capacity ">
                                    </div>
                                    <!-- /.input group -->
                                </div> 
								<div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type=" text" class="form-control " name="username" placeholder="Enter Size-L-H-W">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                               <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" class="form-control"  placeholder="Wheel and axle">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" class="form-control" placeholder="Fuel Capacity"/>
                                        </div>
                                    </div>
                                </div>
