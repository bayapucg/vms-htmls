...
<div class="form-group">
							<a href="#">
								<button type="button" class="btn btn-default btn-sm btn-block toggle-vechile-info-btn more_button right-arrow2">more information<i class="fa fa-arrow-down" aria-hidden="true"></i></button>
							</a>
						</div>
                                            </div>
