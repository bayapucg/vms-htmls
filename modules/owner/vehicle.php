                                    ...
                                    <div id="collapse3" class="panel-collapse collapse">
                                        <div class="panel-body border-1px-ddd py-3 px-4">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <ul class="nav nav-tabs">
                                                        <li class="active"><a data-toggle="tab" href="#tab7">Reviews</a></li>
                                                        <li><a data-toggle="tab" href="#tab8">Features</a></li>
                                                        <li><a data-toggle="tab" href="#tab9">Vechile Images</a></li>
                                                    </ul>
                                                    <div class="tab-content">
