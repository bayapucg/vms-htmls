                                                ...
                                                <table width="100%">
                                                    ...
                                                    <tbody class="row">
                                                        <tr>
                                                            ...
                                                            <td class="bv-capacity col-md-2">
                                                                <div class="form-group bvv-text">Name : Rajendra</div>
                                                                <div class="form-group"><a href="edit-driver.php"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</button></a></div>
																<div class="form-group"><a href="add-driver.php"><button type="button" class="btn btn-danger">+Add Driver</button></a></div>
                                                            </td>
                                                            <td class="bv-capacity col-md-2">
<div>  
    ...
    <label class="onoffswitch1-label" for="myonoffswitch1">
        ...
        <span class="onoffswitch1-switch"></span>
																...
																<div class="form-group"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal"><i class="fa fa-info" aria-hidden="true"></i>Details</button></div>
